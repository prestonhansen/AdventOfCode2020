...
def get_row(boarding_pass: str) -> int:
    ...
    for c in boarding_pass[:7]:
        ...
        if c == 'F':
            ...
            low = mid + 1
    return low if boarding_pass[6] == 'F' else high
...
def get_col(boarding_pass: str) -> int:
    ...
    for c in boarding_pass[-3:]:
        ...
        if c == 'L':
            ...
            low = mid + 1
    return low if boarding_pass[6] == 'L' else high


if __name__ == '__main__':
    # part 1
    seat_ids = [(8 * get_row(p)) + get_col(p) for p in boarding_passes.splitlines()]
    print(max(seat_ids))
